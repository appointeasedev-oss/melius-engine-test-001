  ...
  return (
    <div className='mt-30 max-w-[1600px] mx-auto'>
      ...
      <div className='grid gap-3 justify-center md:grid-cols-2 lg:grid-cols-3 lg:px-10 mt-12'>
        ...
        <Card icon={card2} head='real estate' para='With one digital platform, you can easily list properties, compare them, and provide quick and safe home purchasing options.'/>
        ...
        <Card icon={card5} head='education' para='With an elearning management system, you may get online sessions to in-classroom instruction and digital solutions that make the learning experience engaging.'/>

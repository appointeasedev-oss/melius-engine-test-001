...
const Solutions = () => {
  const solutionsData = [
    ...
    { icon: dev3, head: 'blockchain development', para: 'Cryptocurrency creation, wallet development, smart contract development, and multichain/ hyper ledger solutions are all possible with blockchain.' },
